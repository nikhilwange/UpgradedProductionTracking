...
const CHAKAN_NH_ACTIVITY_STANDARDS: Record<string, number> = {
  "Frame Movement": 120, "Evaporator Installation": 66, "Compressor Installation": 144, "Hydraulic Pump Assembly": 40, "Glycol Pump Assembly": 40, "Evaporator Inlet Pipe": 65, "Discharge Pipe Installation": 36, "Suction Line Installation": 70, "Compressor Housing Mounting": 100, "3-V Coil Mounting 1": 66, "3-V Coil Mounting 2": 66, "4-V Coil Mounting": 88, "Hydraulic Pipe Line Installation": 204, "PHE Mounting": 300, "Hydraulic Piping-1": 450, "Hydraulic Piping-2": 450, "Discharge Line": 265, "Liquid Line": 250, "Glycol Expansion tanks mounting": 180, "Fan Wiring": 450, "Insulation": 540, "Valves Fitting": 260, "Painting": 720, "Wiring": 520, "Control Panel Assembly": 960, "Vacuuming": 315, "Vacuuming 1": 315, "Vacuuming 2": 315, "Refrigerant": 202, "Refrigerant 1": 202, "Refrigerant 2": 202, "Dry Run Test": 883, "EOL": 900, "Finishing": 450
};
...
export const PLANT_REGISTRY: Record<string, any> = {
  "CHAKAN": {
    "models": {
      ...
      "CHILLER_SIFY": {
        mapping: CHAKAN_SIFY_STAGE_MAPPING,
        standards: CHAKAN_SIFY_ACTIVITY_STANDARDS
      },
      "PDX": {
...
export const getModelContext = (serialNo: string, model: string, currentPlant?: string, productLine?: string) => {
  ...
  if (sn.includes('SIFY') || m.includes('SIFY')) {
    return { plant: "CHAKAN", type: "CHILLER_SIFY", ...PLANT_REGISTRY.CHAKAN.models.CHILLER_SIFY };
  }
  ...
  if (sn.includes('SIFY')) return { plant: "CHAKAN", type: "CHILLER_SIFY", ...PLANT_REGISTRY.CHAKAN.models.CHILLER_SIFY };
...
export const OPERATORS_BY_MODEL_LINE: Record<string, string[]> = {
  ...
  "2X": ["Prasad Lukare", "Prashant Jadhav", "Ganesh Chinchgharkar", "Sandeep Pashte", "Mayur Sonavale", "Shailesh Pashte", "Subodh Hardikar", "Tushar Sonavale", "Tejas Somane", "Rohit Jamghare", "Gaurav Perane", "Rohan Vishe", "Kunal Mandwad", "Rohan Gupta", "Rahul Yadav", "Kunal Virale", "Amit Ahirwar", "Ajay Shirke", "Rahul Jamghare", "Kailas Khambale", "Pratham Mohod", "Yash Perane", "Bhavesh Dayare", "Gunvant Shende", "Sahil Shewale", "Avinash Gharat", "Aniket Chavan", "Ritesh Bhosale", "Abhijit Wale", "Harshad Mhatre", "Atish Gavali"],
  "3X": ["Prasad Lukare", "Prashant Jadhav", "Ganesh Chinchgharkar", "Sandeep Pashte", "Mayur Sonavale", "Shailesh Pashte", "Subodh Hardikar", "Tushar Sonavale", "Tejas Somane", "Rohit Jamghare", "Gaurav Perane", "Rohan Vishe", "Kunal Mandwad", "Rohan Gupta", "Rahul Yadav", "Kunal Virale", "Amit Ahirwar", "Ajay Shirke", "Rahul Jamghare", "Kailas Khambale", "Pratham Mohod", "Yash Perane", "Bhavesh Dayare", "Gunvant Shende", "Sahil Shewale", "Avinash Gharat", "Aniket Chavan", "Ritesh Bhosale", "Abhijit Wale", "Harshad Mhatre", "Atish Gavali"],
